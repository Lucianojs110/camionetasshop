    ...
    <div class="col-lg-12">
        <div class="card card-outline-info">
            <div class="card-header" style="background-color:#909497">
                <h4 style="color:white">Editar Cliente</h4>
            </div>
            <div class="card-body">
                <form method="post" action="{{ URL::action('ClientesController@update', $clientes->id_cliente) }}" enctype=multipart/form-data>
                    @csrf
                    @method('PUT')
                    <div class="col-sm-12">
                        <div class="content">
                            ...
                            <div class="row p-t-20">
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nombre" id="nombre" value="{{ $clientes->nombre }}" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="apellido" id="apellido" value="{{ $clientes->apellido }}" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" id="email" value="{{ $clientes->email }}" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="ciudad" id="ciudad" value="{{ $clientes->ciudad }}" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="direccion" id="direccion" value="{{ $clientes->direccion }}" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="telefono" id="telefono" value="{{ $clientes->telefono }}" class="form-control" required>
