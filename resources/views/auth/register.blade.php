            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="link" class="col-md-4 col-form-label text-md-right">Nombre Usuario</label>
                        ...
                        <div class="form-group row">
                            <label for="link" class="col-md-4 col-form-label text-md-right">Tipo de Usuario</label>

                            <div class="col-md-6">
                                <select name="role" class="form-control">
                                
                                    <option value='2'>Agencia</option>
                                    <option value='3'>Social Partner</option>
