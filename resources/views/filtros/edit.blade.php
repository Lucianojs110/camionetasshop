	...
	<div class="col-lg-12">
		<div class="card card-outline-info">
			<div class="card-header" style="background-color:#909497">
                <h4 style="color:white">Editar Filtro</h4>
            </div>
			<div class="card-body">
				<form method="post" action="{{ URL::action('FiltrosController@update', $filtros->id_filtro) }}" enctype=multipart/form-data>
					@csrf
					@method('PUT')
					<div class="col-sm-12">
						<div class="content">
							...
							<div class="col-md-6">
								<div class="form-group">
									<div class="form-group">
										...
										<input type="text" name="descripcion" id="descripcion" class="form-control" value="{{ $filtros->descripcion }}" required>
									</div>
								</div>
							</div>
						</div>
