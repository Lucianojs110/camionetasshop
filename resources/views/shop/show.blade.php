...
<head>
        ...
        <meta property="og:title" content="{{$repuesto->marca}} {{$repuesto->modelo}}-{{$repuesto->año}}" />
        <meta property="og:description" content="{{$repuesto->descripcion}}">
        <meta property="og:type" content="article">
        @foreach($repuesto->imagenprincipal as $img)
        @if ($loop->first)
        <meta property="og:image" content="{{ asset($img->ruta)}}" />
        @endif
        @endforeach
...
<body>
        ...
        <section>
                <div class="container">
                        <div class="col-12 padding-right" style="margin-top:140px">
